require 'drb'
DRb.start_service
Shoes.app(:width => 700, :height => 700, :title => 'Pinky') do
  ...
  @pinky = image('images/pinky.jpg')
  remote_pinky = DRbObject.new(nil,'druby://localhost:7704')
  ...
  keypress do |key|
    ...
    when ' '
      @pinky.move(COLUMNS[@cursor_column-1]-5,ROWS[@cursor_row-1]-5)
      remote_pinky.move_to(COLUMNS[@cursor_column-1]-5,ROWS[@cursor_row-1]-5)
    end
